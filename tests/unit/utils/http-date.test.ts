...
describe('parseHttpDate', () => {
  test('IMF-fixdate', () => {
    const values = {
      'Sun, 06 Nov 1994 08:49:37 GMT': new Date(
        Date.UTC(1994, 10, 6, 8, 49, 37)
      ),
      'Thu, 18 Aug 1950 02:01:18 GMT': new Date(
        Date.UTC(1950, 7, 18, 2, 1, 18)
      ),
      'Wed, 11 Dec 2024 23:20:57 GMT': new Date(
        Date.UTC(2024, 11, 11, 23, 20, 57)
      ),
    ...
    for (const date of Object.keys(values)) {
      // @ts-expect-error date isn't type keyof values
  ...
  test('RFC850', () => {
    const values = {
      'Sunday, 06-Nov-94 08:49:37 GMT': new Date(
        Date.UTC(1994, 10, 6, 8, 49, 37)
      ),
      'Thursday, 18-Aug-50 02:01:18 GMT': new Date(
        Date.UTC(2050, 7, 18, 2, 1, 18)
      ),
      'Wednesday, 11-Dec-24 23:20:57 GMT': new Date(
        Date.UTC(2024, 11, 11, 23, 20, 57)
      ),
